...
class kovaBurcuSayfasi extends StatefulWidget {
  const kovaBurcuSayfasi({Key? key}) : super(key: key);

  @override
  State<kovaBurcuSayfasi> createState() => _kovaBurcuSayfasiState();
}

class _kovaBurcuSayfasiState extends State<kovaBurcuSayfasi> {
              ...
              itemBuilder: (context, index) {
                return Column(
                  ...
                  children: [
                    ...
                    SizedBox(
                      height: 400,
                      child: Image.asset('assets/kovaBilgi.webp'),
                    ),
                    Container(
                      margin: const EdgeInsets.fromLTRB(30, 10, 30, 20),
                      child: Text(
                        '${docSnap[index]["yaziKova"]}',
