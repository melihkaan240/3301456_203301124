...
class kocBurcuSayfasi extends StatefulWidget {
  const kocBurcuSayfasi({Key? key}) : super(key: key);

  @override
  State<kocBurcuSayfasi> createState() => _kocBurcuSayfasiState();
}

class _kocBurcuSayfasiState extends State<kocBurcuSayfasi> {
              ...
              itemBuilder: (context, index) {
                return Column(
                  ...
                  children: [
                    ...
                    SizedBox(
                      height: 400,
                      child: Image.asset('assets/kocBilgi.jpg'),
                    ),
                    Container(
                      margin: const EdgeInsets.fromLTRB(30, 10, 30, 20),
                      child: Text(
                        '${docSnap[index]["yaziKoc"]}',
