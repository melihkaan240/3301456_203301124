...
class AkrepBurcuSayfasi extends StatefulWidget {
  const AkrepBurcuSayfasi({Key? key}) : super(key: key);

  @override
  State<AkrepBurcuSayfasi> createState() => _AkrepBurcuSayfasiState();
}

class _AkrepBurcuSayfasiState extends State<AkrepBurcuSayfasi> {
              ...
              itemBuilder: (context, index) {
                return Column(
                  ...
                  children: [
                    ...
                    SizedBox(
                      height: 400,
                      child: Image.asset('assets/akrepBilgi.png'),
                    ),
                    Container(
                      margin: const EdgeInsets.fromLTRB(30, 10, 30, 20),
                      child: Text(
                        '${docSnap[index]["yaziAkrep"]}',
