...
class ikizlerBurcuSayfasi extends StatefulWidget {
  const ikizlerBurcuSayfasi({Key? key}) : super(key: key);

  @override
  State<ikizlerBurcuSayfasi> createState() => _ikizlerBurcuSayfasiState();
}

class _ikizlerBurcuSayfasiState extends State<ikizlerBurcuSayfasi> {
              ...
              itemBuilder: (context, index) {
                return Column(
                  ...
                  children: [
                    ...
                    SizedBox(
                      height: 400,
                      child: Image.asset('assets/ikizlerBilgi.jpg'),
                    ),
                    Container(
                      margin: const EdgeInsets.fromLTRB(30, 10, 30, 20),
                      child: Text(
                        '${docSnap[index]["yaziIkizler"]}',
