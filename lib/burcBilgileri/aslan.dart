...
class aslanBurcuSayfasi extends StatefulWidget {
  const aslanBurcuSayfasi({Key? key}) : super(key: key);

  @override
  State<aslanBurcuSayfasi> createState() => _aslanBurcuSayfasiState();
}

class _aslanBurcuSayfasiState extends State<aslanBurcuSayfasi> {
              ...
              itemBuilder: (context, index) {
                return Column(
                  ...
                  children: [
                    ...
                    SizedBox(
                      height: 400,
                      child: Image.asset('assets/aslanBilgii.png'),
                    ),
                    Container(
                      margin: const EdgeInsets.fromLTRB(30, 10, 30, 20),
                      child: Text(
                        '${docSnap[index]["yaziAslan"]}',
