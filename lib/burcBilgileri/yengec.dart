...
class yengecBurcuSayfasi extends StatefulWidget {
  const yengecBurcuSayfasi({Key? key}) : super(key: key);

  @override
  State<yengecBurcuSayfasi> createState() => _yengecBurcuSayfasiState();
}

class _yengecBurcuSayfasiState extends State<yengecBurcuSayfasi> {
              ...
              itemBuilder: (context, index) {
                return Column(
                  ...
                  children: [
                    ...
                    SizedBox(
                      height: 400,
                      child: Image.asset('assets/yengecBilgi.png'),
                    ),
                    Container(
                      margin: const EdgeInsets.fromLTRB(30, 10, 30, 20),
                      child: Text(
                        '${docSnap[index]["yaziYengec"]}',
