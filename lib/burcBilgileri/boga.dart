...
class bogaBurcuSayfasi extends StatefulWidget {
  const bogaBurcuSayfasi({Key? key}) : super(key: key);

  @override
  State<bogaBurcuSayfasi> createState() => _bogaBurcuSayfasiState();
}

class _bogaBurcuSayfasiState extends State<bogaBurcuSayfasi> {
              ...
              itemBuilder: (context, index) {
                return Column(
                  ...
                  children: [
                    ...
                    SizedBox(
                      height: 400,
                      child: Image.asset('assets/bogaBilgi.jpg'),
                    ),
                    Container(
                      margin: const EdgeInsets.fromLTRB(30, 10, 30, 20),
                      child: Text(
                        '${docSnap[index]["yaziBoga"]}',
