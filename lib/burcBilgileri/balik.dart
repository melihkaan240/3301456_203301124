...
class balikBurcuSayfasi extends StatefulWidget {
  const balikBurcuSayfasi({Key? key}) : super(key: key);

  @override
  State<balikBurcuSayfasi> createState() => _balikBurcuSayfasiState();
}

class _balikBurcuSayfasiState extends State<balikBurcuSayfasi> {
              ...
              itemBuilder: (context, index) {
                return Column(
                  ...
                  children: [
                    ...
                    SizedBox(
                      height: 400,
                      child: Image.asset('assets/balikBilgi.png'),
                    ),
                    Container(
                      margin: const EdgeInsets.fromLTRB(30, 10, 30, 20),
                      child: Text(
                        '${docSnap[index]["yaziBalik"]}',
