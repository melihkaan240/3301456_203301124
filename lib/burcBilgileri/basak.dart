...
class basakBurcuSayfasi extends StatefulWidget {
  const basakBurcuSayfasi({Key? key}) : super(key: key);

  @override
  State<basakBurcuSayfasi> createState() => _basakBurcuSayfasiState();
}

class _basakBurcuSayfasiState extends State<basakBurcuSayfasi> {
              ...
              itemBuilder: (context, index) {
                return Column(
                  ...
                  children: [
                    ...
                    SizedBox(
                      height: 400,
                      child: Image.asset('assets/basakBilgi.webp'),
                    ),
                    Container(
                      margin: const EdgeInsets.fromLTRB(30, 10, 30, 20),
                      child: Text(
                        '${docSnap[index]["yaziBasak"]}',
