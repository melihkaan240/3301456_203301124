...
class oglakBurcuSayfasi extends StatefulWidget {
  const oglakBurcuSayfasi({Key? key}) : super(key: key);

  @override
  State<oglakBurcuSayfasi> createState() => _oglakBurcuSayfasiState();
}

class _oglakBurcuSayfasiState extends State<oglakBurcuSayfasi> {
              ...
              itemBuilder: (context, index) {
                return Column(
                  ...
                  children: [
                    ...
                    SizedBox(
                      height: 400,
                      child: Image.asset('assets/oglakBilgi.webp'),
                    ),
                    Container(
                      margin: const EdgeInsets.fromLTRB(30, 10, 30, 20),
                      child: Text(
                        '${docSnap[index]["yaziOglak"]}',
